...
// 스트림 중개 연산은 스트림을 전달 받아 중개 연산을 연속 해서 사용
// 필터링 : filter(), distinct()
// 변환 : map(), flatMap()
// 제한 : limit(), skip()
// 정렬 : sorted()
...
//        stream3.limit(7).forEach(s -> System.out.print(s + " "));
//        System.out.println();
//        stream4.skip(4).forEach(s -> System.out.print(s + " ")); // 0 ~ 3까지 제외
//        System.out.println();
