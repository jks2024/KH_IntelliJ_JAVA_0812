...
// Runnable 이용한 익명객체로 구현 하는 방법 (현재의 쓰레드 동작 중 복잡한 계산등이 필요한 경우)
    ...
    public static void main(String[] args) throws InterruptedException {
        ...
        Runnable task2 = () -> {
            try {
                ...
                System.out.println("익명의 쓰레드 합 : " + sum);
