package 메소드오버로딩;
// 메소드오버로딩이란?
// 동일한 메소드를 여러개 정의를 하고 매개변수와 개수와 타입에 따라 다양한게 호출
// 매개변수가 같고 반환 타입만 다른 경우는 안된다.
// 메소드 오버로딩은 객체지향 프로그램의 다향성 대한 특성이다.
public class methodOverEx1 {
    ...
    // 매개변수의 개수가 다르기 때문에 오버로딩 성립 함.
    static int sum(int x, int y, int z, int zz) {
        System.out.println("정수 정수 정수 정수 메소드 호출");
        return x + y + z + zz;
    }
