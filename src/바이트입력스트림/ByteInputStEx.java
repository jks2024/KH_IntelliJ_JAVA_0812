...
// InputStream은 바이트 기반 입력 스트림의 최상위 추상 클래스 입니다.
...
public class ByteInputStEx {
    public static void main(String[] args) throws IOException {
        ...
        // 1 Byte 씩  읽는 방법
//        while(true) {
//            int data = is.read(); // 스트림으로 부터 1바이트를 읽음 (반환 타입이 int형 임)
...
//            if(readByteNum == -1) break; // 파일의 끝... 더 이상 읽을 데이어가 없다는 뜻
...
//        }
        ...
        int readByteNum = is.read(buffer, 2, 3); // 2번 인덱스에서 부터 3개의 값 읽기
        if(readByteNum != -1) {
